...
export const showcases: Showcase[] = [
  {
    ...
    body: "Hit ⌘T from any screen and fuzzy-search all 58 tools. The device bar follows you, so every command targets the device you mean.",
    ticks: [
...
export const galleryShots = [
  ...
  { image: "/assets/screenshot-catalog.webp", alt: "Droidective feature catalog listing all 58 tools with on/off toggles", title: "Feature catalog", caption: "Toggle, reorder, and pin any of the 58 tools." },
]

export const releases: { version: string; date: string; latest?: boolean; html: string }[] = [
  { version: "v3.4.1", date: "Jul 2026", latest: true, html: "<b>Bug-fix release</b> — converting an AAB no longer crashes the app on the newest macOS (the notification-permission request that tells you when a background install finishes ran on the wrong thread — allowed and denied both crashed), and the signing <b>keystore chooser now only accepts <code>.keystore</code> / <code>.jks</code> files</b> in the AAB converter and APK Studio's Sign tab." },
