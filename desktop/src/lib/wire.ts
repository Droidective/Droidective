...
export type * from "@/lib/wire-diagnostics"
...
export interface ActiveOverride {
  /** "proxy" | "layout" | "battery" | "demo" | "animation" | "locale" | "darkMode". */
  kind: string
  /** The daemon's own label, so this client keeps no second copy of the seven. */
  label: string
  value: string
  setAt: number
}
